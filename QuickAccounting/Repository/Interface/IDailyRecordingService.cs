...
namespace QuickAccounting.Repository.Interface
{
	public interface IDailyRecordingService
	{
		...
		Task<bool> SaveEggProductionAsync(string cageNumber, string strainName, DateTime recordDate, int perfectEggCount, decimal perfectEggKg, int brokenEggCount, decimal brokenEggKg, int totalEggCount, decimal totalEggKg, int modifiedBy);
